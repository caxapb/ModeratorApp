...
Продолжение и апдейты проекта после 16 ноября (моего дедлайна) можно найти в [этом репозитории](https://github.com/caxapb/ModeratorApp2). Здесь я улучшаю проект в своих личных целях для практики, выполняю пункты, перечисленные в секции ниже "Что остается на будущее?", к примеру адаптивная верстка, грамотная обработка ошибок и фикс маленьких багов. Начальная стадия в том репозитории = конечная в этом + перемены для адаптивности.

...
3. pages: страницы с соответствующими своими компонентами. Всего 3 страницы: stats - статистика, ads - список объявлений, adCard - карточка товара. Каждая страница - папка и имеет свои дочерние, но не переиспользуемые компоненты (файлы), например чарты на странице статистики. 
